...
const DesignConfigurator: FC<DesignConfiguratorProps> = ({
  ...
  const { mutate: saveConfig, isPending } = useMutation({
    ...
    mutationFn: async (args: SaveConfigTypes) => {
  ...
  return (
    <div className="relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20">
      <div
        ref={containerRef}
        className="relative h-[37.5rem] overflow-hidden col-span-2 w-full max-w-4xl items-center flex justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 "
      >
                      ...
                      <div className="mt-3 space-y-4">
                        {SelectableOptions.map((option) => (
                          <RadioGroup.Option
                            ...
                            className={({ active, checked }) =>
                              cn(
                                "relative block cursor-pointer rounded-lg bg-white px-6 py-4 border-2 border-zinc-200 shadow-sm focus:outline-none ring-0 focus:ring-0 outline-none sm:flex sm:justify-between  ",
                                {
